...
START_TEST(test_plus) {
  ...
  double result =
      calc(reverse_input(push_to_ready(reverse_input(parser(str, 0)))));
...
START_TEST(test_x) {
  char str[256] = "x";
  double result =
      calc(reverse_input(push_to_ready(reverse_input(parser(str, 2.22)))));
...
START_TEST(test_invalid_expr) {
  ...
  ret = check_error(expr);
  ck_assert_int_eq(ret, 1);

  char *str1 = "+";
  ret = check_error(str1);
  ck_assert_int_eq(ret, 1);

  char *str2 = "++";
  ret = check_error(str2);
  ck_assert_int_eq(ret, 1);

  char *str3 = ".";
  ret = check_error(str3);
  ck_assert_int_eq(ret, 1);

  char *str4 = "2q";
  ret = check_error(str4);
  ck_assert_int_eq(ret, 1);

  char *str5 = "1..";
  ret = check_error(str5);
  ck_assert_int_eq(ret, 1);

  char *str7 = "m.^";
  ret = check_error(str7);
  ck_assert_int_eq(ret, 1);

  char *str8 = "$m";
  ret = check_error(str8);
  ck_assert_int_eq(ret, 1);

  char *str9 = "5mp";
  ret = check_error(str9);
  ck_assert_int_eq(ret, 1);

  char *str10 = ")Q";
  ret = check_error(str10);
  ck_assert_int_eq(ret, 1);

  char *str11 = "+-";
  ret = check_error(str11);
  ck_assert_int_eq(ret, 1);

  char *str13 = "mod+";
  ret = check_error(str13);
  ck_assert_int_eq(ret, 1);
}
END_TEST
